...
const featuresList = [
  ...
  },
  {
    icon: Zap,
    title: 'HD Quality',
    description: 'Get the highest available quality — up to 1080p video and 320kbps audio.',
  ...
  },
  {
    ...
    description: 'Use it on phone, tablet, or computer — no app install needed.',
    color: 'text-primary',
    bg: 'bg-primary/10',
  },
  {
    ...
    description: 'No sign-up, no subscription, no hidden fees. Free forever.',
    color: 'text-success',
    bg: 'bg-success/10',
  },
  {
    icon: ShieldCheck,
    title: '100% Secure',
    description: 'We don\'t store your data or downloads. No tracking, no cookies.',
    color: 'text-warning',
    bg: 'bg-warning/10',
  },
  {
    ...
    description: 'Download as MP4 video or extract audio as MP3 — your choice.',
